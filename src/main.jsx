  ...
  function SmallCustomerCard({ row, onClick }) {
    return (
      ...
      >
        ...
        {row.putzereiOpen && (
          <div className="col-span-3 mt-1 rounded bg-violet-50 px-2 py-1 text-xs font-black text-violet-800">
            + Putzerei offen
          </div>
        )}
                      ...
                      <div className="space-y-2">
                        {col.rows.map((row) => (
                          <div key={row.id} className="rounded-xl border bg-white p-3 shadow-sm">
                            ...
                            {row.putzereiOpen && (
                              <div className="mt-2 rounded-lg bg-orange-50 px-3 py-2 text-sm font-black text-orange-800">
                                + Putzerei offen
                              </div>
                            )}
